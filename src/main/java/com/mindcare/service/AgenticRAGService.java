...
public class AgenticRAGService {
    ...
    public AgenticRAGService(VectorStore vectorStore, ChatClient chatClient) {
    ...
    public String generateResponse(String query, String emotionLabel, String riskLevel) {
        ...
        String systemPrompt = "你是一个专业、温暖、有共情能力的校园心理健康助手\"智心AI\"。\n" +
        ...
        if (!context.isEmpty()) {
            systemPrompt += "以下是心理知识库中的参考资料，请用它们来支撑你的回答：\n" + context + "\n\n";
        }

        systemPrompt += "请用中文回答。记住：你面对的可能是一个需要帮助的学生，请用温暖的语言。";
